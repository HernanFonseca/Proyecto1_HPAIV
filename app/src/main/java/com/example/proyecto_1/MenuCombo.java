...
public class MenuCombo extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        menu.add(new Combo(3, "Team Hotdog","2 HD con salsas, papas trituradas y bacon y 2 cervezas",18,(float)5, R.drawable.combo3));
        menu.add(new Combo(4, "Combo amigos","3 HD con pepinillo, guacamoles y papas y 3 cervezas",25,(float)3.5, R.drawable.comboamigos));
